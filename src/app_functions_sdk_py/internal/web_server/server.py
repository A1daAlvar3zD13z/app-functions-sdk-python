...
class WebServer:
    ...
    def __init__(
        self, logger: Logger, service_key: str, service_config: ConfigurationStruct
    ):
    ...
    def add_route(
        ...
        *middleware_func: Callable,
        ...
        self.router.add_api_route(
            ...
            dependencies=[
                Depends(middleware)
                for middleware in middleware_func
    ...
    def create_http_server(self):
        ...
        timeout = isodate.parse_duration(
            "PT" + self.service_config.Service.RequestTimeout.upper()
        )
    ...
    def version(self):
        ...
        return VersionResponse(
            serviceName=self.service_key, version=APPLICATION_VERSION
        )
